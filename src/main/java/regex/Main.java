...
public class Main {
    ...
    public static boolean checkForPassword(String str, int minLength) {
        ...
        final boolean propertyOne = Pattern.matches("(?![^0-9]*$)(?![^a-z]*$)(?![^A-Z]*$).{"+Integer.toString(minLength)+",}", str);
        // as needed, modify this code.
        return propertyOne;
    }

    // Method 2 for checking if a string conforms to a regex: using Matcher.find
    // TODO: Modify this method to return a list of all email addres‘ses contained in the
